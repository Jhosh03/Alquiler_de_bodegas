<%@ Page Title="" Language="C#" MasterPageFile="~/portalweb.Master" AutoEventWireup="true" CodeBehind="coti.aspx.cs" Inherits="Bodegas_de_Guatemala.portal_cotizacion" %>
       ...
       <header class="back-galeria">
        ...
        <div class="h-4/5 flex items-center h-full">
            <div class="text-center mx-auto w-1/2">
                ...
                <h2 class="text-5xl font-bold text-gray-200 uppercase">Cotización</h2>
                <p class="mt-8 text-yellow-400">Con gusto se te brindará más información  
                </p>
            </div>
        </div>
    </header>
