<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_admin.aspx.cs" Inherits="Bodegas_de_Guatemala.frm_admin" %>
...
<body style="background:url(/img/high-level-rack-408222_1920.jpg) no-repeat;">
    <form id="frm_administrador" runat="server">
        
          <div class="container my-5 bg-dark text-light opacity-75">
    <h1 class=" text-center  text-light">BIENVENIDO USUARIO ADMINISTRADOR</h1>
